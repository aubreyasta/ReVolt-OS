          ...
          <div className="window" style={{ maxWidth: 400, width: "100%" }}>
            ...
            >
              ...
              <div style={{ fontSize: 10, color: "var(--text-dim)" }}>
                Resolves once GET /api/batteries/:id/passport is live on the
                backend.
              </div>
              <button
        ...
        <div className="window" style={S.window}>
          <div className="titlebar">
            ...
            <div className="titlebar-title">
              Battery Passport -- {manifest.battery_id}
            </div>
          </div>
          ...
          <div style={S.toolbar} data-print="hide">
            ...
            <button className="aqua-btn" onClick={() => window.print()}>
              Print / Export PDF
            </button>
            <div style={{ flex: 1 }} />
            {manifest?.upcycle_blueprint && (
              <button
                className="aqua-btn"
                onClick={() =>
                  navigate(`/blueprint/${manifest.battery_id}`, {
                    state: { manifest },
                  })
                }
              >
            ...
            <div style={S.sidebar} data-print="hide">
              <div className="inset-panel" style={S.sidePanel}>
                ...
                <div style={S.sideRow}>
                  <span>RUL</span>
                  <span style={{ fontFamily: "var(--font-mono)" }}>
                    {hd.remaining_useful_life_years} yr
                  </span>
                </div>
              </div>
              <div
                className="inset-panel"
                style={{ ...S.sidePanel, marginTop: 8 }}
              >
          ...
          <div style={S.statusBar} data-print="hide">
            ...
            <span style={{ fontFamily: "var(--font-mono)" }}>
              {manifest.updated_at
                ? new Date(manifest.updated_at).toLocaleString()
                : ""}
            </span>
          </div>
        </div>
...
const S = {
  ...
  sideRow: {
    ...
    fontSize: 11,
    padding: "3px 0",
    borderBottom: "1px solid rgba(0,0,60,0.06)",
  },
