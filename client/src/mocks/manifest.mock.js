...
export const MOCK_MANIFEST = {
  ...
  // --- Upcycle Blueprint (generated by Gemini for Certified batteries) ---
  // This is what drives the 3D diagram on AuditPage and BlueprintPage.
  // module_assessment is the key array: each entry becomes one 3D box.
  upcycle_blueprint: {
    target_system: {
      name: "48V Residential Solar Storage",
      target_voltage: 48.0,
      target_capacity_kwh: 5.2,
      topology: "13S2P",
    },
    module_assessment: [
      { module_id: "Module 1", status: "Keep",    cell_voltage_expected: 3.72, reason: "Strong NMC module, 91% capacity retention, balanced within 0.01V", notes: "Front-left — best module in pack" },
      { module_id: "Module 2", status: "Keep",    cell_voltage_expected: 3.70, reason: "Good condition, minor capacity fade within spec", notes: "Front-right" },
      { module_id: "Module 3", status: "Keep",    cell_voltage_expected: 3.68, reason: "Healthy, low cycle wear, consistent discharge curve", notes: "Center-left" },
      { module_id: "Module 4", status: "Bypass",  cell_voltage_expected: 3.41, reason: "High internal resistance detected — likely dendrite growth on Cell 3", notes: "Isolate and label for recycling" },
      { module_id: "Module 5", status: "Keep",    cell_voltage_expected: 3.69, reason: "Within EN 18061 limits, minor thermal wear", notes: "Rear-left" },
      { module_id: "Module 6", status: "Keep",    cell_voltage_expected: 3.71, reason: "Excellent capacity retention at 93%", notes: "Rear-center" },
      { module_id: "Module 7", status: "Replace", cell_voltage_expected: 3.20, reason: "Cell swelling detected on visual inspection — thermal abuse suspected", notes: "DO NOT discharge — use thermal gloves" },
      { module_id: "Module 8", status: "Keep",    cell_voltage_expected: 3.70, reason: "Healthy, consistent with Module 1 metrics", notes: "Rear-right" },
    ],
  },
